<div class="modal fade" id="newDeviceStockCreate" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 500px">
        <div class="modal-content position-relative">
            ...
            <form action="{{route('device-stock.store')}}" method="post">
                @csrf
                <div class="modal-body p-0">
                    <div class="rounded-top-lg py-3 ps-4 pe-6 bg-light">
                        <h4 class="mb-1" id="modalExampleDemoLabel">Add Device Stock</h4>
                    </div>
                    <div class="p-4 pb-0">
                        <div class="mb-3">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary submitBtn" disabled type="submit">Submit</button>
                </div>
            </form>
        </div>
    </div>
