...
<body>
            ...
            <div class="row flex-center min-vh-100 py-6 text-center">
                <div class="col-sm-10 col-md-8 col-lg-6 col-xxl-5">
                    <a class="d-flex flex-center mb-4" href="/">
                        <img class="me-2" src="{{asset('images/logo.svg')}}" alt="" width="58" />
                    ...
                    <div class="card">
                        <div class="card-body p-4 p-sm-5">
                            ...
                            <hr />
                            <p>Try refreshing the page, or going back and attempting the action again. If this problem
                                persists, please go to home page.</p>
                            <a class="btn btn-primary btn-sm mt-3" href="/"><span class="fas fa-home me-2"></span>Take
                                me home</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1"
        ...
        <div class="offcanvas-body scrollbar-overlay px-card" id="themeController">
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start">
                    ...
                    <div class="flex-1">
                        ...
                        <a class="fs--1" href="../../documentation/customization/configuration.html">RTL
                            Documentation</a>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start">
                    ...
                    <div class="flex-1">
                        ...
                        <a class="fs--1" href="../../documentation/customization/configuration.html">Fluid
                            Documentation</a>
                    </div>
                </div>
                <div class="form-check form-switch">
            ...
            <p>
                <a class="fs--1" href="../../modules/components/navs-and-tabs/vertical-navbar.html#navbar-styles">See
                    Documentation</a>
            </p>
            <div class="btn-group d-block w-100 btn-group-navbar-style">
                <div class="row gx-2">
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-card">
                            <img class="img-fluid img-prototype" src="../../assets/img/generic/card.png" alt="" /><span
