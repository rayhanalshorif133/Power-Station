                    ...
                    <div class="col-md-6">
                        <div class="d-flex align-items-center justify-content-end my-3">
                            ...
                            <div class="d-none ms-3" id="bulk-select-actions">
                                <div class="d-flex">
                                    <select class="form-select form-select-sm areaActionSelect"
                                        aria-label="Bulk actions">
                                        <option selected="selected">Actions</option>
                                        <option value="delete">Delete</option>
                                    </select>
                                    <button class="btn btn-falcon-danger btn-sm ms-2 areaApplyBtn"
                            ...
                            <tr id="{{$deviceArea->id}}">
                                <td class="align-middle white-space-nowrap">
                                    <div class="form-check mb-0">
                                        <input class="form-check-input areaCheckInput" type="checkbox" id="checkbox-1"
                                            data-bulk-select-row="data-bulk-select-row" />
                                    </div>
                                </td>
                                <td class="align-middle text-capitalize">{{$deviceArea->name}}</td>
                                <td class="align-middle text-capitalize">{{$deviceArea->addedBy->name}}</td>
...
@include('device.area.create')
@endsection


@section('scripts')
<script src="{{asset('js/device/area.js')}}"></script>
@endsection