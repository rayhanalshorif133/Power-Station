                    ...
                    <div class="col-md-6">
                        <div class="d-flex align-items-center justify-content-end my-3">
                            ...
                            <div class="d-none ms-3" id="bulk-select-actions">
                                <div class="d-flex">
                                    <select class="form-select form-select-sm deviceStatusActionSelect"
                                        aria-label="Bulk actions">
                                        <option selected="selected">Actions</option>
                                        <option value="delete">Delete</option>
                                    </select>
                                    <button class="btn btn-falcon-danger btn-sm ms-2 deviceStatusApplyBtn"
                    ...
                    <table class="table mb-0 customDataTable">
                        <thead class="text-black bg-200">
                            <tr>
                                ...
                                <th class="align-middle">Status Name</th>
                        ...
                        <tbody id="bulk-select-body">
                            ...
                            <tr id="{{$deviceStatus->id}}">
                                <td class="align-middle white-space-nowrap">
                                    <div class="form-check mb-0">
                                        <input class="deviceStatusCheckbox form-check-input" type="checkbox"
                                            id="checkbox-1" data-bulk-select-row="data-bulk-select-row" />
                                    </div>
                                </td>
                                <td class="align-middle text-capitalize statusName">{{$deviceStatus->name}}</td>
                                <td class="align-middle text-capitalize statusAddedBy ">{{$deviceStatus->addedBy->name}}
                                </td>
