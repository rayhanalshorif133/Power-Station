...
<div class="row g-3 mb-3">
    <div class="col-md-6 col-xxl-3">
        <div class="card h-md-100 ecommerce-card-min-width">
            <div class="card-header pb-0">
                <h6 class="mb-0 mt-2 d-flex align-items-center">Total get update<span class="ms-1 text-400"
    ...
    <div class="col-md-6 col-xxl-3">
        <div class="card h-md-100">
            <div class="card-header pb-0">
                <h6 class="mb-0 mt-2">Total get update</h6>
            </div>
            <div class="card-body d-flex flex-column justify-content-end">
    ...
    <div class="col-lg-6 pe-lg-2 mb-3">
        <div class="card h-lg-100 overflow-hidden">
            ...
            <div class="card-footer bg-light p-0"><a class="btn btn-sm btn-link d-block w-100 py-2" href="#!">Show all
                    projects<span class="fas fa-chevron-right ms-1 fs--2"></span></a>
            </div>
        </div>
    </div>
        ...
        <div class="card h-lg-100">
            ...
            <div class="card-body position-relative">
                ...
                <p class="fs--1 mb-0">Your storage will be running out soon. Get more space and powerful
                    productivity features.</p><a class="btn btn-link fs--1 text-warning mt-lg-3 ps-0" href="#!">Upgrade
            ...
            <div class="card-body pb-0">
                <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="border h-100 w-100 fit-cover rounded-2"
                            src="{{asset('assets/img/products/5-thumb.png')}}" alt="" />
                    </div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                        ...
                        <div class="hover-actions end-0 top-50 translate-middle-y"><a
                                ...
                                href="{{asset('assets/img/icons/cloud-download.svg')}}" download="download"><img
                                    src="{{asset('assets/img/icons/cloud-download.svg')}}" alt="" width="15" /></a>
                ...
                <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="border h-100 w-100 fit-cover rounded-2"
                            src="{{asset('assets/img/products/3-thumb.png')}}" alt="" />
                    </div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                ...
                <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    <div class="file-thumbnail"><img class="border h-100 w-100 fit-cover rounded-2"
                            src="{{asset('assets/img/products/2-thumb.png')}}" alt="" />
                    </div>
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
