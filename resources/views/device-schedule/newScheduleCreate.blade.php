<div class="modal fade" id="addNewSchedule" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <form action="{{route('device-schedule.store')}}" method="post">
                ...
                <div class="modal-body p-0">
                    <div class="rounded-top-lg py-3 ps-4 pe-6 bg-light">
                        <h4 class="mb-1" id="modalExampleDemoLabel">Add new Schedule </h4>
                    </div>
                    <div class="p-4 pb-0">
                        <input type="number" class="d-none" name="device_id" id="setDeviceId" value="" />
                        <div class="mb-3">
