                        ...
                        <div class="card-header">
                            <div class="row flex-between-end">
                                <div class="col-auto align-self-center">
                                    <h5 class="mb-0">Issue Forwarded Pending List</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table mb-0 customDataTable">
                        <thead class="text-black bg-200">
                            <tr>
                                ...
                                <th class="align-middle">Forwarded Department</th>
                                <th class="align-middle">Forwarded Status</th>
                        ...
                        <tbody id="bulk-select-body">
                            ...
                            <tr id="{{$issue->id}}">
                                ...
                                <th class="align-middle text-capitalize">
                                    @foreach ($issue->forwardedDepartments as $forwardedDepartment)
