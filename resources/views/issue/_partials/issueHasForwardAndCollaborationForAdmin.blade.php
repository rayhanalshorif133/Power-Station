...
<div class="alert alert-danger border-2 d-flex align-items-center" role="alert">
    ...
    <p class="mb-0 flex-1">
        ...
        @endif
        @endforeach
        Department want to work permit this issue in your department.
    </p>
    <div class="d-flex flex-center">
        <div class="m-2">
            <a href="{{route('issue.workPermitStatusUpdate', [$issue->id,'rejected'])}}">
                <button class="btn btn-falcon-danger me-1 mb-1 btn-sm" type="button">Not Now</button>
            </a>
        </div>
        <div class="m-2">
            <a href="{{route('issue.workPermitStatusUpdate', [$issue->id,'accepted'])}}">
                <button class="btn btn-falcon-success me-1 mb-1 btn-sm" type="button">Accept</button>
            </a>
        </div>
    </div>
