<div class="modal fade" id="editIssue" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 590px">
        <div class="modal-content position-relative">
            ...
            <form action="{{route('issue.update')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body p-0">
                    <div class="rounded-top-lg py-3 ps-4 pe-6 bg-light">
                        <h4 class="mb-1" id="modalExampleDemoLabel">Update issue </h4>
                    </div>
                    <div class="p-4 pb-0">
                        <input class="d-none" type="text" name="issue_id" id="issue_id" value="" placeholder="issue id"
                            required>
                        <div class="mb-3">
                        ...
                        <div class="mb-3 row">
                            <div class="col-md-6">
                                ...
                                <span class="appendDepartmentSelect"></span>
                            </div>
                            <div class="col-md-6">
                                <label class="col-form-label" for="image">Image</label>
                                <input type="file" class="form-control" id="editImage" name="image" placeholder="Image">
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="col-form-label" for="recommendation">Recommendation<span
                                    class="text-danger">*</span></label>
                            <textarea class="form-control" id="editRecommendation" name="recommendation" rows="2"
